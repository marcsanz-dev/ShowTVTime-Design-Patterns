...
![](pictures/ApendixB_DataBaseWindow.png)

Hauràs de veure una llengüeta a la dreta de la interfície del IntelliJ que posa Database.

Si allà no se'n mostra cap, indica on està la Base de Dades, seleccionant DataSource i escull SQLite:

![img2.png](pictures/ApendixB_AfegirDataSourceMenu.png)

Al dialeg de Data Sources and Drivers, done-li a obrir per poder cercar la base de dades a afegir. 

![](pictures/ApendixB_AfegirDataSourceDialeg.png)

I en el menú, posa on està la nostra base de dades (fitxer data.sqlite dins de la carpeta Data dels DAOs tipus DB):

![](pictures/ApendixB_AfegirDataSourceDialegDataDAOS.png)

Ara, només cal que acceptis clicant el botó Apply per continuar afegint més Data Sources o bé el botó OK per aplicar i tancar la finestra:

![](pictures/ApendixB_AfegirDataSourceDialegAplicarCanvis.png)
...
![](pictures/ApendixB_AfegirDataSourceRefrescar.png)

Finalment, selecciona la taula dins de main-\>tables i podràs veure el seu contingut

![](pictures/ApendixB_AfegirDataSourceMainTables.png)
...
![](pictures/ApendixB_AfegirNouDataBotoAfegirFila.png)

3. Recorda a omplir tots els camps (excepte els que diuen \<generated\> que s'omplen automàticament per la Base de Dades):

![](pictures/ApendixB_AfegirNouDataReomplir.png)

4. Prem el botó de Submit per a actualitzar la BD:

![](pictures/ApendixB_AfegirNouDataSubmit.png)

Vigila fer els canvis de la base de dades quan no estiguis executant el projecte. 
